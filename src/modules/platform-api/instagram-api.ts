...
// that cookie jar via Electron's `session.fetch()`. When the user is not logged
// in (or cookies expired) the endpoints 401/redirect; we treat that as "offline"
// and return null rather than throwing, to avoid noisy poll errors.
